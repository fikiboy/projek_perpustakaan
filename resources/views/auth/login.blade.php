...
<script>
    ...
    // 1. Pop-up Gagal Login (Sandi salah/Akun tidak ada)
    ...
    // 2. Pop-up Menunggu Persetujuan Admin (Baru Daftar)

    @if(session('wait_admin'))
        ...
        Swal.fire({
            ...
            text: "{{ session('wait_admin') }}",

            confirmButtonColor: '#007bff',

            confirmButtonText: 'Siap, Saya Tunggu',
