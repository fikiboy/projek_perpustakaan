...
<body>
   ...
   <div class="bottom-nav shadow-lg">
    ...
    <script>
        ...
        @if(session('success_tambah')) Toast.fire({ icon: 'success', title: "{{ session('success_tambah') }}" }); @endif
        @if(session('success_hapus')) Toast.fire({ icon: 'success', title: "{{ session('success_hapus') }}" }); @endif
        @if(session('success_kembali')) Toast.fire({ icon: 'success', title: "{{ session('success_kembali') }}" }); @endif
        @if(session('success_profil')) Toast.fire({ icon: 'success', title: "{{ session('success_profil') }}" }); @endif
        @if(session('error')) Toast.fire({ icon: 'error', title: "{{ session('error') }}" }); @endif

        @if(session('popup_ulasan'))
            Swal.fire({
                title: 'Berhasil!',
                text: "{{ session('popup_ulasan') }}",
                icon: 'success',
